...
public class StrKit {
    ...
    /**
     * @description: 判断指定字符串与给定长度是否匹配
     * @author: LEIYU
     */
    public static boolean compareLength(String str, Integer length) {
    ...
    /**
     * @description: 替换指定字符串的指定内容为*
     *
     * @author: LEIYU
     */
    public static String replaceStrToStar(String str,String rep){
        if(str.indexOf(rep)!=-1){
            return str.replaceAll(rep,repeat('*',2));
        }else{
            return str;
        }
    }
