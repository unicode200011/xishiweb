...
public class ImgQrTool {
    ...
    private static OSSUtil ossUtil = SpringUtils.getBean(OSSUtil.class);
    /**
     * 生成带图片的二维码
     *
     ...
     * @since 2.3.0
     */
    public static String createSimpleQr(String content, int width, int height, String destImagePath) {
        ...
        try {
            fileName = getFileName(destImagePath);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return fileName;
    ...
    private static String getFileName(String path) throws IOException {
        ...
        MultipartFile multipartFile = new MockMultipartFile(path, inputStream);
        String fileName = ossUtil.uploadQrCode2OSS(multipartFile, "qrCode",name);
        return fileName;
    }
...
//        }
//        createSimpleQr("哈哈哈,这是内容", 20, 20, "src/main/java/com/stylefeng/guns/core/qr/1.jpg");
        String ossPath = "http://dazongguan.oss-cn-shenzhen.aliyuncs.com/resources/";
        ImgQrTool.createSimpleQr("哈哈哈,这是内容", 300, 300, "E:\\qrCode");
    }
}
