...
public class JwtTokenUtil {
     ...
     */
    public String generateToken(String userName, Long userId, String randomKey) {
     ...
     * 生成token
     */
    private String doGenerateToken(Map<String, Object> claims, String subject, Long usrId) {
