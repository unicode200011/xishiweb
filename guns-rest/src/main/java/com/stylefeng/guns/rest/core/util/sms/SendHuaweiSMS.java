...
public class SendHuaweiSMS {
    ...
    public static String sendCode(String phone){
        ...
        String appKey = "NXLcaTKJ9LQfPzavr8yq8DtqExeE"; //APP_Key
        String appSecret = "vq5EmIvU8MKTeKKyDpk7TZbDU5OM"; //APP_Secret
        String sender = "8819082616732"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "4205b787cfb246af91a7c695a4dd0020"; //模板ID

        //条件必填,国内短信关注,当templateId指定的模板类型为通用模板时生效且必填,必须是已审核通过的,与模板类型一致的签名名称
        //国际/港澳台短信不用关注该参数
        String signature = "西施"; //签名名称

        //必填,全局号码格式(包含国家码),示例:+8615123456789,多个号码之间用英文逗号分隔
        String receiver = "+86"+phone.trim(); //短信接收人号码
         ...
         */
        String code = ToolUtil.getRandomNum(6);
    ...
    public static void main(String[] args) {
        String s = SendHuaweiSMS.sendCode("13281255998");
