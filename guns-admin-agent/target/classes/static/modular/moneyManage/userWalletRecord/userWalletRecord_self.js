...
UserWalletRecord.initColumn = function () {
    return [
        ...
        {title: '用户ID', field: 'xishiNum', visible: true, align: 'center', valign: 'middle'},
        ...
        {title: '收益事项', field: 'type', visible: true, align: 'center', valign: 'middle',
        ...
        {title: '名称', field: 'custName', visible: true, align: 'center', valign: 'middle'},
        {title: '礼物数量', field: 'custNum', visible: true, align: 'center', valign: 'middle'},
        {title: '总价值（西施币）', field: 'amount', visible: true, align: 'center', valign: 'middle'},
    ];
};
...
$(function () {
    ...
    var table = new BSTable(UserWalletRecord.id, "/userWalletRecord/list", defaultColunms);
