...
!function (e) {
    ...
    return function n(e, f, o) {
        ...
        1: [function (n, f) {
            (function (n, o) {
                (function () {
                    ...
                    function u() {
                        var e = 0, n = new P(c), f = document.createTextNode("");
                        return n.observe(f, {characterData: !0}), function () {
                            f.data = e = ++e % 2
                        }
                    }
                    ...
                    function h(e, n) {
                        if (n.constructor === e.constructor) g(e, n); else {
                            var f = v(n);
                    ...
                    function z(e, n, f, o) {
                        var d = e._subscribers, i = d.length;
                        e._onerror = null, d[i] = n, d[i + T] = f, d[i + U] = o, 0 === i && e._state && N(A, e)
                    }

                    function A(e) {
                        var n = e._subscribers, f = e._state;
                        if (0 !== n.length) {
                    ...
                    var K, L = J, M = (Date.now || function () {
                        ...
                        P = O.MutationObserver || O.WebKitMutationObserver,
                    ...
                    var S = void 0, T = 1, U = 2, V = new B, W = new B;
                    ...
                    var Y = function (e, n) {
                        ...
                        var f = this, o = new f(y, n);
                        return q(o, e), o
                    }, en = 0, nn = I;
                    I.all = Y, I.race = Z, I.resolve = $, I.reject = _, I.prototype = {
                        constructor: I,
                        then: function (e, n) {
                            var f = this, o = f._state;
                            if (o === T && !e || o === U && !n) return this;
                            var d = new this.constructor(y), i = f._result;
                            if (o) {
                                var t = arguments[o - 1];
                                N(function () {
                                    D(o, d, t, i)
            ...
            var t = e("./log"), l = e("./promise");
            n.exports = function (e, n, o, t, s, u, a) {
                var p = d(e.documentElement, s.javascriptEnabled), c = n.createElement("iframe");
                return c.className = "html2canvas-container", c.style.visibility = "hidden", c.style.position = "fixed", c.style.left = "-10000px", c.style.top = "0px", c.style.border = "0", c.width = o, c.height = t, c.scrolling = "no", n.body.appendChild(c), new l(function (n) {
                    var o = c.contentWindow.document;
                    c.contentWindow.onload = c.onload = function () {
                        var e = setInterval(function () {
                            o.body.childNodes.length > 0 && (i(o.documentElement), clearInterval(e), "view" === s.type && (c.contentWindow.scrollTo(u, a), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || c.contentWindow.scrollY === a && c.contentWindow.scrollX === u || (o.documentElement.style.top = -a + "px", o.documentElement.style.left = -u + "px", o.documentElement.style.position = "absolute")), n(c))
                        }, 50)
                    }, o.open(), o.write("<!DOCTYPE html><html></html>"), f(e, u, a), o.replaceChild(o.adoptNode(p), o.documentElement), o.close()
                })
            }
        }, {"./log": 15, "./promise": 18}], 5: [function (e, n) {
            function f(e) {
            ...
            f.prototype.rgba = function (e) {
                ...
                if (n) this.r = n[0], this.g = n[1], this.b = n[2]; else if ("transparent" === e.toLowerCase()) return this.r = this.g = this.b = this.a = 0, !0;
                return !!n
            ...
            function o(e, n, f, o, i) {
                return b(e, e, f, o, n, e.defaultView.pageXOffset, e.defaultView.pageYOffset).then(function (t) {
                    ...
                    var u = t.contentWindow, p = u.document.querySelector(s),
            ...
            function d(e, n, f, o, d) {
                var u = n.contentWindow, a = new p(u.document), c = new y(f, a), r = h(e),
                    w = "view" === f.type ? o : l(u.document), b = "view" === f.type ? d : s(u.document),
            ...
            var a = e("./promise"), p = e("./support"), c = e("./renderers/canvas"), y = e("./imageloader"),
                m = e("./nodeparser"), r = e("./nodecontainer"), v = e("./log"), w = e("./utils"), b = e("./clone"),
                g = e("./proxy").loadUrlDocument, h = w.getBounds, x = "data-html2canvas-node", j = 0;
            ...
            var o = e("./promise"), d = e("./log"), i = e("./utils").smallImage;
            n.exports = f
        }, {"./log": 15, "./promise": 18, "./utils": 29}], 8: [function (e, n) {
            function f(e, n) {
            ...
            var o = e("./promise");
            n.exports = f
        }, {"./promise": 18}], 13: [function (e, n) {
            function f(e, n) {
                this.link = null, this.options = e, this.support = n, this.origin = this.getOrigin(window.location.href)
            }

            var o = e("./promise"), d = e("./log"), i = e("./imagecontainer"), t = e("./dummyimagecontainer"),
                l = e("./proxyimagecontainer"), s = e("./framecontainer"), u = e("./svgcontainer"),
                a = e("./svgnodecontainer"), p = e("./lineargradientcontainer"), c = e("./webkitgradientcontainer"),
                y = e("./utils").bind;
            ...
            function f(e) {
                ...
                n ? e.args[0].split(" ").reverse().forEach(function (e) {
                    ...
                    var n = e.match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)|\w+)\s*(\d{1,3})?(%|px)?/);
                    return {color: new d(n[1]), stop: "%" === n[3] ? n[2] / 100 : null}
        ...
        }, {"./color": 5, "./gradientcontainer": 11}], 15: [function (e, n) {
            n.exports = function () {
        ...
        }, {"./color": 5, "./utils": 29}], 17: [function (e, n) {
            ...
            function s(e, n, f) {
                var o = e.left, d = e.top, i = e.width, t = e.height, s = n[0][0], u = n[0][1], a = n[1][0],
                    p = n[1][1], c = n[2][0], y = n[2][1], m = n[3][0], r = n[3][1], v = i - a, w = t - y, b = i - c,
                    g = t - r;
                return {
            ...
            var N = e("./log"), O = e("punycode"), P = e("./nodecontainer"), Q = e("./textcontainer"),
                R = e("./pseudoelementcontainer"), S = e("./fontmetrics"), T = e("./color"), U = e("./promise"),
                V = e("./stackingcontext"), W = e("./utils"), X = W.bind, Y = W.getBounds, Z = W.parseBackgrounds,
                $ = W.offsetBounds;
            ...
            var _ = {inset: [["darken", .6], ["darken", .1], ["darken", .1], ["darken", .6]]};
        ...
        }, {"es6-promise": 1}], 19: [function (e, n, f) {
            function o(e, n, f) {
            ...
            var a = e("./promise"), p = e("./xhr"), c = e("./utils"), y = e("./log"), m = e("./clone"), r = c.decode64,
                v = 0;
            f.Proxy = o, f.ProxyURL = d, f.loadUrlDocument = u
        }, {"./clone": 4, "./log": 15, "./promise": 18, "./utils": 29, "./xhr": 31}], 20: [function (e, n) {
            function f(e, n) {
            ...
            var o = e("./proxy").ProxyURL, d = e("./promise");
            n.exports = f
        }, {"./promise": 18, "./proxy": 19}], 21: [function (e, n) {
            function f(e, n, f) {
        ...
        }, {"./nodecontainer": 16}], 22: [function (e, n) {
            function f(e, n, f, o, d) {
        ...
        }, {"../lineargradientcontainer": 14, "../log": 15, "../renderer": 22}], 24: [function (e, n) {
            function f(e, n, f, d) {
        ...
        }, {"./nodecontainer": 16}], 25: [function (e, n) {
            function f(e) {
            ...
            var o = e("./promise"), d = e("./xhr"), i = e("./utils").decode64;
        ...
        }, {"./promise": 18, "./utils": 29, "./xhr": 31}], 27: [function (e, n) {
            function f(e, n) {
                this.src = e, this.image = null;
                var f = this;
            ...
            var o = e("./svgcontainer"), d = e("./promise");
            f.prototype = Object.create(o.prototype), n.exports = f
        }, {"./promise": 18, "./svgcontainer": 26}], 28: [function (e, n) {
            function f(e, n) {
                d.call(this, e, n)
            }
        ...
        }, {"./nodecontainer": 16}], 29: [function (e, n, f) {
            ...
            f.prototype = Object.create(o.prototype), n.exports = f
        }, {"./gradientcontainer": 11}], 31: [function (e, n) {
            function f(e) {
