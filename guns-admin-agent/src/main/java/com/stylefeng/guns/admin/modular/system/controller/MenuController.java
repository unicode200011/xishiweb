...
import com.stylefeng.guns.admin.common.constant.dictmap.MenuDict;
import com.stylefeng.guns.admin.common.constant.factory.ConstantFactory;
import com.stylefeng.guns.admin.common.constant.state.MenuStatus;
...
import com.stylefeng.guns.admin.modular.system.service.MenuService;
import com.stylefeng.guns.admin.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public List<ZTreeNode> menuTreeList() {
        List<ZTreeNode> roleTreeList = this.menuDao.menuTreeList(null);
        return roleTreeList;
    }
    ...
    public List<ZTreeNode> menuTreeListByRoleId(@PathVariable Integer roleId) {
        ...
        for (Integer integer : roleList) {
            List<Long> menuIdsByRoleId = this.menuDao.getMenuIdsByRoleId(integer);
            menuIds2.addAll(menuIdsByRoleId);
        }
        List<Long> menuIds = this.menuDao.getMenuIdsByRoleId(roleId);
        if (ToolUtil.isEmpty(menuIds)) {
            List<ZTreeNode> roleTreeList = this.menuDao.menuTreeList(menuIds2);
            return roleTreeList;
        } else {
            List<ZTreeNode> roleTreeListByUserId = this.menuDao.menuTreeListByMenuIds(menuIds,menuIds2);
