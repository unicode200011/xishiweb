...
import com.stylefeng.guns.admin.common.constant.DatasourceEnum;
import com.stylefeng.guns.admin.core.datascope.DataScopeInterceptor;
...
@MapperScan(basePackages = {"com.stylefeng.guns.admin.modular.*.dao", "com.stylefeng.guns.persistence.dao"})
