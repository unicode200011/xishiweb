...
import com.stylefeng.guns.admin.common.exception.HtmlToPdfInterceptor;
...
//       String path  = "D:/wkhtmltopdf/bin/wkhtmltopdf.exe";
//       String savePath = "E:/pdf";
//       DateUtils.convert("http://admin.tk.nhys.cdnhxx.com/bearProject/downloadPdf/89",savePath+"/baidu.pdf",path);
        List<String> lastDaysDateStr = DateUtils.getLastDaysDateStr(new Date(), -3);
        System.out.println(lastDaysDateStr);
    }
