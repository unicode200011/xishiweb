...
import com.stylefeng.guns.admin.common.constant.dictmap.DeptDict;
...
import com.stylefeng.guns.admin.modular.system.dao.DeptDao;
import com.stylefeng.guns.admin.modular.system.service.DeptService;
import com.stylefeng.guns.admin.modular.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    public Object list(@RequestParam(required = false, defaultValue = "1") Integer pageNumber,
        ...
        List<Map<String, Object>> list = this.deptDao.list(page,condition);
        super.warpObject(new DeptWarpper(list));
