...
import com.stylefeng.guns.admin.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.stylefeng.guns.admin.common.annotion.BussinessLog)")
    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        String visitIP = HttpKit.getVisitIp();
        ...
        LogManager.me().executeLog(LogTaskFactory.bussinessLog(user.getId(), bussinessName, className, methodName, msg,visitIP));
    }
}