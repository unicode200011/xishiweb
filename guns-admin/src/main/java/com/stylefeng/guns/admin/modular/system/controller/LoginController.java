...
public class LoginController extends BaseController {
    ...
    public String index(Model model) {
        ...
        for (Integer integer : roleList) {
            if (integer == 2) {
                model.addAttribute("tips", "该用户没有权限，无法登陆");
                return "/login.html";
            }
        }
...
//        nettyClient.sendMsg(rpcRequest);
        ...
        System.out.println("_______________1____________");
        ...
        System.out.println("_______________2____________");
        ...
        System.out.println("_______________3____________");
