...
import com.stylefeng.guns.admin.common.constant.dictmap.DictMap;
...
import com.stylefeng.guns.admin.modular.system.service.DictService;
import com.stylefeng.guns.admin.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
    ...
    public Object list(String condition) {
        ...
        super.warpObject(new DictWarpper(list));
        Page<Map<String, Object>> crowdPage = new Page<>();
        crowdPage.setTotal(list.size());
        crowdPage.setRecords(list);
        return crowdPage;
    }
