...
OptLog.initColumn = function () {
    return [
        ...
        {title: '操作者电话', field: 'userPhone', align: 'center', valign: 'middle'},
        {title: 'IP地址', field: 'ip', align: 'center', valign: 'middle'
        },
        {title: '操作时间', field: 'create_time', align: 'center', valign: 'middle', sortable: true},
        {title: '操作记录', field: 'logname', align: 'center', valign: 'middle', sortable: true},
        ]
};
